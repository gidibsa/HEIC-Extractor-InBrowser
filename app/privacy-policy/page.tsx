...
export default function PrivacyPolicy() {
    return (
        ...
        <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
            <p>Effective Date: Fri 15 Nov 2024</p>
            <p>
                At HEIC Extractor, we are committed to safeguarding your privacy. This Privacy Policy outlines our practices
            ...
            <div className="space-y-2">
                <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">
                    3. Local Processing & Data Storage
                </h2>
                <p>
                    All file processing in HEIC Extractor takes place locally in your browser. No data is uploaded to a server, ensuring that your files remain private and secure on your device.
                </p>
            </div>
            ...
            <div className="space-y-2">
                <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">5. Data Security</h2>
                <p>
            ...
            <div className="space-y-2">
                <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">6. Third-Party Links</h2>
                <p>
            ...
            <div className="space-y-2">
                <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">7. Children&apos;s Privacy</h2>
                <p>
            ...
            <div className="space-y-2">
                <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">9. Contact Us</h2>
                <p>
                    If you have any questions or concerns about this Privacy Policy or the data we collect, please
                    contact us at ayomidegidigbi61@gmail.com.
                </p>
            </div>

            <p>
                By using HEIC Extractor, you agree to the practices outlined in this Privacy Policy. Please discontinue use of
